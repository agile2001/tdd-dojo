package com.agile2001.tdd.web.rest;
...
import com.agile2001.tdd.service.mapper.RoleMapper;
...
class RoleResourceIT {
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role().roleName(DEFAULT_ROLE_NAME).roleKey(DEFAULT_ROLE_KEY);
        return role;
    }
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role().roleName(UPDATED_ROLE_NAME).roleKey(UPDATED_ROLE_KEY);
        return role;
    }
    ...
    void createRole() throws Exception {
        ...
        assertThat(testRole.getRoleKey()).isEqualTo(DEFAULT_ROLE_KEY);
    }
    ...
    void putExistingRole() throws Exception {
        ...
        updatedRole.roleName(UPDATED_ROLE_NAME).roleKey(UPDATED_ROLE_KEY);
        ...
        assertThat(testRole.getRoleKey()).isEqualTo(UPDATED_ROLE_KEY);
    }
    ...
    void partialUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.roleKey(UPDATED_ROLE_KEY);
    ...
    void fullUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.roleName(UPDATED_ROLE_NAME).roleKey(UPDATED_ROLE_KEY);
