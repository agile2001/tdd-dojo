...
import com.agile2001.tdd.service.RoleService;
import com.agile2001.tdd.service.dto.RoleDTO;
import com.agile2001.tdd.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.agile2001.tdd.domain.Role}.
 */
@RestController
@RequestMapping("/api")
public class RoleResource {
    ...
    private static final String ENTITY_NAME = "tddDojoRole";
     ...
     */
    @GetMapping("/roles")
    public ResponseEntity<List<RoleDTO>> getAllRoles(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
